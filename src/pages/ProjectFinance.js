        ...
        <Col xs={12} md={4}>
          <Card>
            <Card.Body>
              ...
              <Card.Text>Instructions Lorem ipsum dolor sit amet.</Card.Text>
            </Card.Body>
          </Card>
        </Col>
      </Row>
        ...
        <Col className="mb-3" sm={12} md={4}>
          <Card>
            <Card.Body>
              ...
              <ListGroup horizontal>
                <ListGroup.Item className="w-50">Interest Rate</ListGroup.Item>
                <ListGroup.Item className="w-50">ListGroup</ListGroup.Item>
              </ListGroup>
              <ListGroup horizontal>
                <ListGroup.Item className="w-50">Commitment Fee</ListGroup.Item>
                <ListGroup.Item className="w-50">ListGroup</ListGroup.Item>
              </ListGroup>
              <ListGroup horizontal>
                <ListGroup.Item className="w-50">
        ...
        <Col className="mb-3" sm={12} md={4}>
          <Card>
            <Card.Body>
              ...
              <ListGroup className="w-full" horizontal>
                <ListGroup.Item className="w-50">Discount Rate</ListGroup.Item>
                <ListGroup.Item className="w-50">ListGroup</ListGroup.Item>
              </ListGroup>
              <ListGroup horizontal>
                <ListGroup.Item className="w-50">
