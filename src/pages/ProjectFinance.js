        ...
        <Row className="mb-3">
          <Col xs={12} md={8}>
            <Message variant={"light"}>
              ...
              project. If you’re unsure what to put you can prefill or can hover
              for more information. You can leave any field blank but it will
              likely impact the validity of feasibility.
            </Message>
          </Col>
        </Row>
